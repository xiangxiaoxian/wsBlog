...
public class ArticleController {
    ...
    @PutMapping()
    public Result insertOrUpdateArticleByArticleId(@RequestBody Article article, @RequestBody Sort sort, @RequestBody Lable lable){
        return articleService.insertOrUpdateArticleByArticleId(article,sort,lable);
    }
